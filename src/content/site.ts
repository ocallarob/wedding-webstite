export const site = {
  ...
  rsvpDeadline: 'Kindly RSVP by August 1, 2026',
  galleryImages: [
    '/photos/1.svg',
    '/photos/2.svg',
    '/photos/3.svg',
      ...
      events: [
        {
          ...
          locationUrl: 'https://www.google.com/maps/search/?api=1&query=St+Mary%27s+Church+Arney+Fermanagh',
      ...
      events: [
        {
          ...
          locationUrl: 'https://www.charliesbarenniskillen.co.uk/',
